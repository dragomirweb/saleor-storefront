// colors
export const priamryColor = "#60ba62";
export const priamryColorLight = "#429c44";
export const secondaryColor = "#808000";
...
export const turquoise = priamryColor;
export const turquoiseDark = "#06a09e";
export const turquoiseLight = priamryColorLight;
